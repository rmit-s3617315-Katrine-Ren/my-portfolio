          ...
          <section className="flex flex-col items-center gap-4 text-center sm:items-start sm:text-left">
            ...
            <ul>
              ...
              <li className="text-lg text-stone-500">
                ...
                <li className="text-lg text-stone-500">
                <a href="https://volley.com/" className="font-medium text-zinc-950 dark:text-zinc-50" target="_blank" rel="noopener noreferrer">Volley</a> Shopify Replatforming Project | Architected the end-to-end Shopify Liquid storefront for the Hush Puppies replatforming, engineering dynamic product pages (PLP/PDP) and a seamless AJAX-driven mini-cart.</li>
